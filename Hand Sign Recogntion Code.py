...
def segment(image, grayimage, threshold=75): 
 ...
 thresholded = cv2.threshold(grayimage, threshold, 255, 
cv2.THRESH_BINARY)[1] 
...
def count(image, thresholded, segmented): 
 ...
 distances = pairwise.euclidean_distances([(cX, cY)], Y=[extreme_left, 
...
cv2.putText(clone, "This is " + str(fingers), (70, 45), 
